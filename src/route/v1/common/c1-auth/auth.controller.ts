...
export default class AuthController {
  constructor(private readonly authService: AuthService, private readonly userService: UserService, private logger: CustomLoggerService) {}
   ...
   */
  @Post('sign-out')
  async signout(@GetCurrentUserId() userId: Types.ObjectId, @Body('deviceID') deviceID: string) {
    // Remove deviceID and pop fcm token
    await this.userService.removeDeviceID(new Types.ObjectId(userId), deviceID);
