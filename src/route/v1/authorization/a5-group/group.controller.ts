...
export default class GroupController {
  ...
  @HttpCode(200)
  async removeGroupDetail(@Param('id', ParseObjectIdPipe) id: Types.ObjectId, @Body() body: AddGroupDetailDto): Promise<any> {
  ...
  @HttpCode(200)
  async removeGroupDetails(@Param('id', ParseObjectIdPipe) id: Types.ObjectId, @Body() body: AddGroupDetailsDto): Promise<any> {
  ...
  @HttpCode(201)
  async addGroupDetail(@Param('id', ParseObjectIdPipe) id: Types.ObjectId, @Body() body: AddGroupDetailDto): Promise<any> {
  ...
  @HttpCode(201)
  async addGroupDetails(@Param('id', ParseObjectIdPipe) id: Types.ObjectId, @Body() body: AddGroupDetailsDto): Promise<any> {
  ...
  @Put(':id/update-users')
  @HttpCode(201)
  async addUsers(@Param('id', ParseObjectIdPipe) id: Types.ObjectId, @Body() body: AddUsersDto): Promise<any> {
    ...
    const updatePromise = body.users.map((userId: string) => this.userService.updateGroup(new Types.ObjectId(userId), id, options));
  ...
  @Put(':id')
  @HttpCode(200)
  async update(@Param('id', ParseObjectIdPipe) id: Types.ObjectId, @Body() body: UpdateGroupDto): Promise<any> {
  ...
  async deleteManyByIds(@Param('ids') ids: string): Promise<any> {
    ...
    // Delete groups
    const groupsDeletedPromise = this.groupService.deleteManyHardByIds(_ids);
